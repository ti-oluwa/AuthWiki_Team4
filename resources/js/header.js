...
function darkMode() {
    ...
    if (window.location.href.includes('settings') == true){
        ...
        document.getElementById('popup_success').style.boxShadow = "rgba(31, 31, 31, 0.7) 0px 0px 0px 100vmax, rgba(0, 0, 0, 0.6) 0px 0px 10px 5px";
        document.getElementById('delete_confirm').style.backgroundColor = "#2f2f2f";
        document.getElementById('delete_confirm').style.boxShadow = "rgba(31, 31, 31, 0.7) 0px 0px 0px 100vmax, rgba(0, 0, 0, 0.6) 0px 0px 10px 5px";
